...
class delete():
	...
	def ok_interface(self):
		if self.index == "学院数据":
			...
			if (string_college_id == "''") and (string_college_abstract == "''"):
				tkinter.messagebox.showinfo(title = '教育管理系统', message = '请输入内容')
				return None
			...
			self.cnxn.commit()
			tkinter.messagebox.showinfo(title = '教育管理系统', message = '删除成功')
		if self.index == "专业数据":
			...
			if (string_major_no == '') and (string_major_depart == "''") and (string_major_name == "''"):
				tkinter.messagebox.showinfo(title = '教育管理系统', message = '请输入内容')
				return None
			if string_major_no == '':
		...
		if self.index == "班级数据":
			...
			if (string_class_no == '') and (string_class_depart == "''") and \
					(string_class_year == '') and (string_class_tutor == "''"):
				tkinter.messagebox.showinfo(title = '教育管理系统', message = '请输入内容')
				return None
			if string_class_no == '':
		...
		if self.index == "教师数据":
			...
			if (string_teacher_no == '') and (string_teacher_name == "''") and \
					(string_teacher_sex == "''") and (string_teacher_polistatus == "''") and \
					(string_professional == "''") and (string_teacher_tel == "''") and \
					(string_teacher_depart == "''") and (string_teacher_college == "''") and \
					(string_teacher_entry == '') and (string_teacher_pwd == "''"):
				tkinter.messagebox.showinfo(title = '教育管理系统', message = '请输入内容')
				return None
		...
		if self.index == "教室数据":
			...
			if (string_class_room_no == '') and (string_class_room_name == "''") and \
					(string_class_room_building  == "''") and (string_class_room_capacity == "''"):
				tkinter.messagebox.showinfo(title = '教育管理系统', message = '请输入内容')
				return None
		...
		if self.index == "课程数据":
			...
			if (string_course_no == '') and (string_course_name == "''") and \
					(string_course_depart == "''") and (string_course_kind == "''") and \
					(string_course_period == '') and (string_course_describe == "''"):
				tkinter.messagebox.showinfo(title = '教育管理系统', message = '请输入内容')
				return None
			if string_course_no == '':
		...
		if self.index == "学生数据":
			...
			if (string_student_no == '') and (string_class_no == '') and \
					(string_student_name == "''") and (string_student_sex == "''") and \
					(string_student_birth == "''") and (string_student_polistatus == "''") and \
					(string_student_nation == "''") and (string_student_home == "''") and \
					(string_student_home_tel == "''") and (string_student_spec == "''") and \
					(string_student_entry == '') and (string_student_pwd == "''"):
				tkinter.messagebox.showinfo(title = '教育管理系统', message = '请输入内容')
				return None
