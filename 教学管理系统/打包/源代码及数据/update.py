...
class update():
	...
	def gui_arrang(self):
		if self.index == "学院数据":
			self.root.geometry('650x200+400+200')
			...
			self.button_ok.place(x=200, y=130)
			self.button_back.place(x=400, y=130)
			# 更新
			self.label_1 = tkinter.Label(self.root, text = '→')
			self.label_1.place(x=350, y= 60)
			self.input_college_id_r = tkinter.Entry(self.root, width = 30)
			self.input_college_id_r.place(x=370, y=60)
			self.label_2 = tkinter.Label(self.root, text = '→')
			self.label_2.place(x=350, y= 85)
			self.input_college_abstract_r = tkinter.Entry(self.root, width = 30)
			self.input_college_abstract_r.place(x=370, y=85)
		if self.index == "专业数据":
			self.root.geometry('650x200+400+200')
			...
			self.button_ok.place(x=200, y=150)
			self.button_back.place(x=400, y=150)
			# 更新
			self.label_1 = tkinter.Label(self.root, text = '→')
			self.label_1.place(x=350, y= 60)
			self.input_major_no_r = tkinter.Entry(self.root, width = 30)
			self.input_major_no_r.place(x=370, y=60)
			self.label_2 = tkinter.Label(self.root, text = '→')
			self.label_2.place(x=350, y= 85)
			self.input_major_depart_r = tkinter.Entry(self.root, width = 30)
			self.input_major_depart_r.place(x=370, y=85)
			self.label_3 = tkinter.Label(self.root, text = '→')
			self.label_3.place(x=350, y= 110)
			self.input_major_name_r = tkinter.Entry(self.root, width = 30)
			self.input_major_name_r.place(x=370, y=110)
		if self.index == "班级数据":
			self.root.geometry('650x220+400+200')
			...
			self.button_back.place(x=400, y=170)
			# 更新
			self.label_1 = tkinter.Label(self.root, text = '→')
			self.label_1.place(x=350, y= 60)
			self.input_class_no_r = tkinter.Entry(self.root, width = 30)
			self.input_class_no_r.place(x=370, y=60)
			self.label_2 = tkinter.Label(self.root, text = '→')
			self.label_2.place(x=350, y= 85)
			self.input_class_depart_r = tkinter.Entry(self.root, width = 30)
			self.input_class_depart_r.place(x=370, y=85)
			self.label_3 = tkinter.Label(self.root, text = '→')
			self.label_3.place(x=350, y= 110)
			self.input_class_year_r = tkinter.Entry(self.root, width = 30)
			self.input_class_year_r.place(x=370, y=110)
			self.label_4 = tkinter.Label(self.root, text = '→')
			self.label_4.place(x=350, y= 135)
			self.input_class_tutor_r = tkinter.Entry(self.root, width = 30)
			self.input_class_tutor_r.place(x=370, y=135)
		if self.index == "教师数据":
			self.root.geometry('650x350+400+200')
			...
			self.button_ok.place(x=200, y=295)
			self.button_back.place(x=400, y=295)
			# 更新
			self.label_1 = tkinter.Label(self.root, text = '→')
			self.label_1.place(x=350, y= 60 - 30)
			self.input_teacher_no_r = tkinter.Entry(self.root, width = 30)
			self.input_teacher_no_r.place(x=370, y=60 - 30)
			self.label_2 = tkinter.Label(self.root, text = '→')
			self.label_2.place(x=350, y= 85 - 30)
			self.input_teacher_name_r = tkinter.Entry(self.root, width = 30)
			self.input_teacher_name_r.place(x=370, y=85 - 30)
			self.label_3 = tkinter.Label(self.root, text = '→')
			self.label_3.place(x=350, y= 110 - 30)
			self.input_teacher_sex_r = tkinter.Entry(self.root, width = 30)
			self.input_teacher_sex_r.place(x=370, y=110 - 30)
			self.label_4 = tkinter.Label(self.root, text = '→')
			self.label_4.place(x=350, y= 135 - 30)
			self.input_teacher_polistatus_r = tkinter.Entry(self.root, width = 30)
			self.input_teacher_polistatus_r.place(x=370, y=135 - 30)
			self.label_5 = tkinter.Label(self.root, text = '→')
			self.label_5.place(x=350, y= 160 - 30)
			self.input_professional_r = tkinter.Entry(self.root, width = 30)
			self.input_professional_r.place(x=370, y=160 - 30)
			self.label_6 = tkinter.Label(self.root, text = '→')
			self.label_6.place(x=350, y= 185 - 30)
			self.input_teacher_tel_r = tkinter.Entry(self.root, width = 30)
			self.input_teacher_tel_r.place(x=370, y=185 - 30)
			self.label_7 = tkinter.Label(self.root, text = '→')
			self.label_7.place(x=350, y= 210 - 30)
			self.input_teacher_depart_r = tkinter.Entry(self.root, width = 30)
			self.input_teacher_depart_r.place(x=370, y=210 - 30)
			self.label_8 = tkinter.Label(self.root, text = '→')
			self.label_8.place(x=350, y= 235 - 30)
			self.input_teacher_college_r = tkinter.Entry(self.root, width = 30)
			self.input_teacher_college_r.place(x=370, y=235 - 30)
			self.label_9 = tkinter.Label(self.root, text = '→')
			self.label_9.place(x=350, y= 260 - 30)
			self.input_teacher_entry_r = tkinter.Entry(self.root, width = 30)
			self.input_teacher_entry_r.place(x=370, y=260 - 30)
			self.label_10 = tkinter.Label(self.root, text = '→')
			self.label_10.place(x=350, y= 285 - 30)
			self.input_teacher_pwd_r = tkinter.Entry(self.root, width = 30)
			self.input_teacher_pwd_r.place(x=370, y=285 - 30)
		if self.index == "教室数据":
			self.root.geometry('650x220+400+200')
			...
			self.button_ok.place(x=200, y=175)
			self.button_back.place(x=400, y=175)
			# 更新
			self.label_1 = tkinter.Label(self.root, text = '→')
			self.label_1.place(x=350, y= 60)
			self.input_class_room_no_r = tkinter.Entry(self.root, width = 30)
			self.input_class_room_no_r.place(x=370, y=60)
			self.label_2 = tkinter.Label(self.root, text = '→')
			self.label_2.place(x=350, y= 85)
			self.input_class_room_name_r = tkinter.Entry(self.root, width = 30)
			self.input_class_room_name_r.place(x=370, y=85)
			self.label_3 = tkinter.Label(self.root, text = '→')
			self.label_3.place(x=350, y= 110)
			self.input_class_room_building_r = tkinter.Entry(self.root, width = 30)
			self.input_class_room_building_r.place(x=370, y=110)
			self.label_4 = tkinter.Label(self.root, text = '→')
			self.label_4.place(x=350, y= 135)
			self.input_class_room_capacity_r = tkinter.Entry(self.root, width = 30)
			self.input_class_room_capacity_r.place(x=370, y=135)
		if self.index == "课程数据":
			self.root.geometry('650x280+400+200')
			...
			self.button_ok.place(x=200, y=225)
			self.button_back.place(x=400, y=225)
			# 更新
			self.label_1 = tkinter.Label(self.root, text = '→')
			self.label_1.place(x=350, y= 60)
			self.input_course_no_r = tkinter.Entry(self.root, width = 30)
			self.input_course_no_r.place(x=370, y=60)
			self.label_2 = tkinter.Label(self.root, text = '→')
			self.label_2.place(x=350, y= 85)
			self.input_course_name_r = tkinter.Entry(self.root, width = 30)
			self.input_course_name_r.place(x=370, y=85)
			self.label_3 = tkinter.Label(self.root, text = '→')
			self.label_3.place(x=350, y= 110)
			self.input_course_depart_r = tkinter.Entry(self.root, width = 30)
			self.input_course_depart_r.place(x=370, y=110)
			self.label_4 = tkinter.Label(self.root, text = '→')
			self.label_4.place(x=350, y= 135)
			self.input_course_kind_r = tkinter.Entry(self.root, width = 30)
			self.input_course_kind_r.place(x=370, y=135)
			self.label_5 = tkinter.Label(self.root, text = '→')
			self.label_5.place(x=350, y= 160)
			self.input_course_period_r = tkinter.Entry(self.root, width = 30)
			self.input_course_period_r.place(x=370, y=160)
			self.label_6 = tkinter.Label(self.root, text = '→')
			self.label_6.place(x=350, y= 185)
			self.input_course_describe_r = tkinter.Entry(self.root, width = 30)
			self.input_course_describe_r.place(x=370, y=185)
		if self.index == "学生数据":
			self.root.geometry('650x400+400+200')
			...
			self.button_ok.place(x=200, y=345)
			self.button_back.place(x=400, y=345)
			# 更新
			self.label_1 = tkinter.Label(self.root, text = '→')
			self.label_1.place(x=350, y= 60 -30 )
			self.input_student_no_r = tkinter.Entry(self.root, width = 30)
			self.input_student_no_r.place(x=370, y=60 - 30)
			self.label_2 = tkinter.Label(self.root, text = '→')
			self.label_2.place(x=350, y= 85 - 30)
			self.input_class_no_r = tkinter.Entry(self.root, width = 30)
			self.input_class_no_r.place(x=370, y=85 - 30)
			self.label_3 = tkinter.Label(self.root, text = '→')
			self.label_3.place(x=350, y= 110 - 30)
			self.input_student_name_r = tkinter.Entry(self.root, width = 30)
			self.input_student_name_r.place(x=370, y=110 - 30)
			self.label_4 = tkinter.Label(self.root, text = '→')
			self.label_4.place(x=350, y= 135 - 30)
			self.input_student_sex_r = tkinter.Entry(self.root, width = 30)
			self.input_student_sex_r.place(x=370, y=135 - 30)
			self.label_5 = tkinter.Label(self.root, text = '→')
			self.label_5.place(x=350, y= 160 - 30)
			self.input_student_birth_r = tkinter.Entry(self.root, width = 30)
			self.input_student_birth_r.place(x=370, y=160 - 30)
			self.label_6 = tkinter.Label(self.root, text = '→')
			self.label_6.place(x=350, y= 185 - 30)
			self.input_student_polistatus_r = tkinter.Entry(self.root, width = 30)
			self.input_student_polistatus_r.place(x=370, y=185 - 30)
			self.label_7 = tkinter.Label(self.root, text = '→')
			self.label_7.place(x=350, y= 210 - 30)
			self.input_student_nation_r = tkinter.Entry(self.root, width = 30)
			self.input_student_nation_r.place(x=370, y=210 - 30)
			self.label_8 = tkinter.Label(self.root, text = '→')
			self.label_8.place(x=350, y= 235 - 30)
			self.input_student_home_r = tkinter.Entry(self.root, width = 30)
			self.input_student_home_r.place(x=370, y=235 - 30)
			self.label_9 = tkinter.Label(self.root, text = '→')
			self.label_9.place(x=350, y= 260 - 30)
			self.input_student_home_tel_r = tkinter.Entry(self.root, width = 30)
			self.input_student_home_tel_r.place(x=370, y=260 - 30)
			self.label_10 = tkinter.Label(self.root, text = '→')
			self.label_10.place(x=350, y= 285 - 30)
			self.input_student_spec_r = tkinter.Entry(self.root, width = 30)
			self.input_student_spec_r.place(x=370, y=285 - 30)
			self.label_11 = tkinter.Label(self.root, text = '→')
			self.label_11.place(x=350, y= 310 - 30)
			self.input_student_entry_r = tkinter.Entry(self.root, width = 30)
			self.input_student_entry_r.place(x=370, y=310 - 30)
			self.label_12 = tkinter.Label(self.root, text = '→')
			self.label_12.place(x=350, y= 335 - 30)
			self.input_student_pwd_r = tkinter.Entry(self.root, width = 30)
			self.input_student_pwd_r.place(x=370, y=335 - 30)
	...
	def ok_interface(self):
		if self.index == "学院数据":
			...
			string_college_id_r = "'" + self.input_college_id_r.get() + "'"
			string_college_abstract_r = "'" + self.input_college_abstract_r.get() + "'"
			if string_college_id_r != "''":
				opr_string = "\
					update college\
					set college_id = " + string_college_id_r\
					+ "where(college_id = " + string_college_id + " and college_abstract = " \
				 	+ string_college_abstract + ")"
				self.cursor.execute(opr_string)
				self.cnxn.commit()
				self.cursor.execute(opr_string)
			if string_college_abstract_r != "''":
				opr_string = "\
					update college\
					set college_abstract = " + string_college_abstract_r\
					+ "where(college_id = " + string_college_id + " and college_abstract = " \
				 	+ string_college_abstract + ")"
				self.cursor.execute(opr_string)
				self.cnxn.commit()
		...
		if self.index == "专业数据":
			...
			string_major_no_r = self.input_major_no_r.get()
			string_major_depart_r = "'" + self.input_major_depart_r.get() + "'"
			string_major_name_r = "'" + self.input_major_name_r.get() + "'"
			if string_major_no_r != '':
				opr_string = "\
					update major\
					set major_no = " + string_major_no_r\
					+ "where(major_no = " + string_major_no + "and major_depart = "\
					+ string_major_depart + "and major_name = "\
					+ string_major_name + ")"
				self.cursor.execute(opr_string)
				self.cnxn.commit()
			if string_major_depart_r != "''":
				opr_string = "\
					update major\
					set major_depart = " + string_major_depart_r\
					+ "where(major_no = " + string_major_no + "and major_depart = "\
					+ string_major_depart + "and major_name = "\
					+ string_major_name + ")"
				self.cursor.execute(opr_string)
				self.cnxn.commit()
			if string_major_name_r != "''":
				opr_string = "\
					update major\
					set major_name = " + string_major_name_r\
					+ "where(major_no = " + string_major_no + "and major_depart = "\
					+ string_major_depart + "and major_name = "\
					+ string_major_name + ")"
				self.cursor.execute(opr_string)
		...
		if self.index == "班级数据":
			...
			string_class_no_r = self.input_class_no_r.get()
			string_class_depart_r = "'" + self.input_class_depart_r.get() + "'"
			string_class_year_r = self.input_class_year_r.get()
			string_class_tutor_r = "'" + self.input_class_tutor_r.get() + "'"
			if string_class_no_r != '':
				opr_string = "\
					update class\
					set class_no = " + string_class_no_r\
				...
				self.cursor.execute(opr_string)
				self.cnxn.commit()
			if string_class_depart_r != "''":
				opr_string = "\
					update class\
					set class_depart = " + string_class_depart_r\
					+ "where(class_no = " + string_class_no + " and class_depart = "\
					+ string_class_depart + " and class_year = "\
					+ string_class_year + " and class_tutor = "\
					+ string_class_tutor + ")"
				self.cursor.execute(opr_string)
				self.cnxn.commit()
			if string_class_year_r != '':
				opr_string = "\
					update class\
					set class_year = " + string_class_year_r\
					+ "where(class_no = " + string_class_no + " and class_depart = "\
					+ string_class_depart + " and class_year = "\
					+ string_class_year + " and class_tutor = "\
					+ string_class_tutor + ")"
				self.cursor.execute(opr_string)
				self.cnxn.commit()
			if string_class_tutor_r != "''":
				opr_string = "\
					update class\
					set class_tutor = " + string_class_tutor_r\
					+ "where(class_no = " + string_class_no + " and class_depart = "\
					+ string_class_depart + " and class_year = "\
					+ string_class_year + " and class_tutor = "\
					+ string_class_tutor + ")"
		...
		if self.index == "教师数据":
			...
			string_teacher_no_r = self.input_teacher_no_r.get()
			string_teacher_name_r = "'" + self.input_teacher_name_r.get() + "'"
			string_teacher_sex_r = "'" + self.input_teacher_sex_r.get() + "'"
			string_teacher_polistatus_r = "'" + self.input_teacher_polistatus_r.get() + "'"
			string_professional_r = "'" + self.input_professional_r.get() + "'"
			string_teacher_tel_r = "'" + self.input_teacher_tel_r.get() + "'"
			string_teacher_depart_r = "'" + self.input_teacher_depart_r.get() + "'"
			string_teacher_college_r = "'" + self.input_teacher_college_r.get() + "'"
			string_teacher_entry_r = self.input_teacher_entry_r.get()
			string_teacher_pwd_r = "'" + self.input_teacher_pwd_r.get() + "'"
			if string_teacher_no_r != '':
				opr_string = "\
					update teacher\
					set teacher_no = " + string_teacher_no_r\
				...
				self.cursor.execute(opr_string)
				self.cnxn.commit()
			if string_teacher_name_r != "''":
				opr_string = "\
					update teacher\
					set teacher_name = " + string_teacher_name_r\
					+ "where(teacher_no = " + string_teacher_no + " and teacher_name = "\
					+ string_teacher_name + " and teacher_sex = "\
					+ string_teacher_sex + " and teacher_polistatus = "\
					+ string_teacher_polistatus + " and professional = "\
				...
				self.cursor.execute(opr_string)
				self.cnxn.commit()
			if string_teacher_sex_r != "''":
				opr_string = "\
					update teacher\
					set teacher_sex = " + string_teacher_sex_r\
					+ "where(teacher_no = " + string_teacher_no + " and teacher_name = "\
					+ string_teacher_name + " and teacher_sex = "\
					+ string_teacher_sex + " and teacher_polistatus = "\
					+ string_teacher_polistatus + " and professional = "\
				...
				self.cursor.execute(opr_string)
				self.cnxn.commit()
			if string_teacher_polistatus_r != "''":
				opr_string = "\
					update teacher\
					set teacher_polistatus = " + string_teacher_polistatus_r\
					+ "where(teacher_no = " + string_teacher_no + " and teacher_name = "\
					+ string_teacher_name + " and teacher_sex = "\
					+ string_teacher_sex + " and teacher_polistatus = "\
					+ string_teacher_polistatus + " and professional = "\
				...
				self.cursor.execute(opr_string)
				self.cnxn.commit()
			if string_professional_r != "''":
				opr_string = "\
					update teacher\
					set professional = " + string_professional_r\
					+ "where(teacher_no = " + string_teacher_no + " and teacher_name = "\
					+ string_teacher_name + " and teacher_sex = "\
					+ string_teacher_sex + " and teacher_polistatus = "\
					+ string_teacher_polistatus + " and professional = "\
				...
				self.cursor.execute(opr_string)
				self.cnxn.commit()
			if string_teacher_tel_r != "''":
				opr_string = "\
					update teacher\
					set teacher_tel = " + string_teacher_tel_r\
					+ "where(teacher_no = " + string_teacher_no + " and teacher_name = "\
					+ string_teacher_name + " and teacher_sex = "\
					+ string_teacher_sex + " and teacher_polistatus = "\
					+ string_teacher_polistatus + " and professional = "\
				...
				self.cursor.execute(opr_string)
				self.cnxn.commit()
			if string_teacher_depart_r != "''":
				opr_string = "\
					update teacher\
					set teacher_depart= " + string_teacher_depart_r\
					+ "where(teacher_no = " + string_teacher_no + " and teacher_name = "\
					+ string_teacher_name + " and teacher_sex = "\
					+ string_teacher_sex + " and teacher_polistatus = "\
					+ string_teacher_polistatus + " and professional = "\
				...
				self.cursor.execute(opr_string)
				self.cnxn.commit()
			if string_teacher_college_r != "''":
				opr_string = "\
					update teacher\
					set teacher_college = " + string_teacher_college_r\
					+ "where(teacher_no = " + string_teacher_no + " and teacher_name = "\
					+ string_teacher_name + " and teacher_sex = "\
					+ string_teacher_sex + " and teacher_polistatus = "\
					+ string_teacher_polistatus + " and professional = "\
				...
				self.cursor.execute(opr_string)
				self.cnxn.commit()
			if string_teacher_entry_r != '':
				opr_string = "\
					update teacher\
					set teacher_entry = " + string_teacher_entry_r\
					+ "where(teacher_no = " + string_teacher_no + " and teacher_name = "\
					+ string_teacher_name + " and teacher_sex = "\
					+ string_teacher_sex + " and teacher_polistatus = "\
					+ string_teacher_polistatus + " and professional = "\
				...
				self.cursor.execute(opr_string)
				self.cnxn.commit()
			if string_teacher_pwd_r != "''":
				opr_string = "\
					update teacher\
					set teacher_pwd = " + string_teacher_pwd_r\
					+ "where(teacher_no = " + string_teacher_no + " and teacher_name = "\
					+ string_teacher_name + " and teacher_sex = "\
					+ string_teacher_sex + " and teacher_polistatus = "\
					+ string_teacher_polistatus + " and professional = "\
		...
		if self.index == "教室数据":
			...
			string_class_room_no_r = self.input_class_room_no_r.get()
			string_class_room_name_r = "'" + self.input_class_room_name_r.get() + "'"
			string_class_room_building_r = "'" + self.input_class_room_building_r.get() + "'"
			string_class_room_capacity_r = "'" + self.input_class_room_capacity_r.get() + "'"
			if string_class_room_no_r != '':
				opr_string = "\
					update class_room\
					set class_room_no = " + string_class_room_no_r\
			...
			if string_class_room_name_r != "''":
				...
				self.cursor.execute(opr_string)
				self.cnxn.commit()
			if string_class_room_building_r != "''":
				opr_string = "\
					update class_room\
					set class_room_building = " + string_class_room_building_r\
					+ "class_room_no = " + string_class_room_no + " and class_room_name = "\
					+ string_class_room_name + " and class_room_building = "\
					+ string_class_room_building + " and class_room_capacity = "\
					+ string_class_room_capacity + ")"
				self.cursor.execute(opr_string)
				self.cnxn.commit()
			if string_class_room_capacity_r != "''":
				opr_string = "\
					update class_room\
					set class_room_capacity = " + string_class_room_capacity_r\
					+ "where(class_room_no = " + string_class_room_no + " and class_room_name = "\
					+ string_class_room_name + " and class_room_building = "\
					+ string_class_room_building + " and class_room_capacity = "\
					+ string_class_room_capacity + ")"
		...
		if self.index == "课程数据":
			...
			string_course_no_r = self.input_course_no_r.get()
			string_course_name_r = "'" + self.input_course_name_r.get() + "'"
			string_course_depart_r = "'" + self.input_course_depart_r.get() + "'"
			string_course_kind_r = "'" + self.input_course_kind_r.get() + "'"
			string_course_period_r = self.input_course_period_r.get()
			string_course_describe_r = "'" + self.input_course_describe_r.get() + "'"
			if string_course_no_r != '':
				opr_string = "\
					update course\
					set course_no = " + string_course_no_r\
				...
				self.cursor.execute(opr_string)
				self.cnxn.commit()
			if string_course_name_r != "''":
				opr_string = "\
					update course\
					set course_name = " + string_course_name_r\
					+ "where(course_no = " + string_course_no + " and course_name = "\
					+ string_course_name + " and course_depart = "\
					+ string_course_depart + " and course_kind = "\
					+ string_course_kind + " and course_period = "\
				...
				self.cursor.execute(opr_string)
				self.cnxn.commit()
			if string_course_depart_r != "''":
				opr_string = "\
					update course\
					set course_depart = " + string_course_depart_r\
					+ "where(course_no = " + string_course_no + " and course_name = "\
					+ string_course_name + " and course_depart = "\
					+ string_course_depart + " and course_kind = "\
					+ string_course_kind + " and course_period = "\
				...
				self.cursor.execute(opr_string)
				self.cnxn.commit()
			if string_course_kind_r != "''":
				opr_string = "\
					update course\
					set course_kind = " + string_course_kind_r\
					+ "where(course_no = " + string_course_no + " and course_name = "\
					+ string_course_name + " and course_depart = "\
					+ string_course_depart + " and course_kind = "\
					+ string_course_kind + " and course_period = "\
				...
				self.cursor.execute(opr_string)
				self.cnxn.commit()
			if string_course_period_r != '':
				opr_string = "\
					update course\
					set course_period = " + string_course_period_r\
					+ "where(course_no = " + string_course_no + " and course_name = "\
					+ string_course_name + " and course_depart = "\
					+ string_course_depart + " and course_kind = "\
					+ string_course_kind + " and course_period = "\
				...
				self.cursor.execute(opr_string)
				self.cnxn.commit()
			if string_course_describe_r != "''":
				opr_string = "\
					update course\
					set course_describe = " + string_course_describe_r\
					+ "where(course_no = " + string_course_no + " and course_name = "\
					+ string_course_name + " and course_depart = "\
					+ string_course_depart + " and course_kind = "\
					+ string_course_kind + " and course_period = "\
		...
		if self.index == "学生数据":
			...
			string_student_no_r = self.input_student_no_r.get()
			string_class_no_r = self.input_class_no_r.get()
			string_student_name_r = "'" + self.input_student_name_r.get() + "'"
			string_student_sex_r = "'" + self.input_student_sex_r.get() + "'"
			string_student_birth_r = "'" + self.input_student_birth_r.get() + "'"
			string_student_polistatus_r = "'" + self.input_student_polistatus_r.get() + "'"
			string_student_nation_r = "'" + self.input_student_nation_r.get() + "'"
			string_student_home_r = "'" + self.input_student_home_r.get() + "'"
			string_student_home_tel_r = "'" + self.input_student_home_tel_r.get() + "'"
			string_student_spec_r = "'" + self.input_student_spec_r.get() + "'"
			string_student_entry_r = self.input_student_entry_r.get()
			string_student_pwd_r = "'" + self.input_student_pwd_r.get() + "'"
			if string_student_no_r != '':
				opr_string = "\
					update student\
					set student_no = " + string_student_no_r\
					+ "where(student_no = "\
			...
			if string_class_no_r != '':
				opr_string = "\
					...
					+ string_student_nation + " and student_home = "\
					+ string_student_home + " and student_home_tel = "\
					+ string_student_home_tel + " and student_spec = "\
					+ string_student_spec + " and student_entry = "\
					+ string_student_entry + " and student_pwd = "\
					+ string_student_pwd + ")"
				self.cursor.execute(opr_string)
				self.cnxn.commit()
			if string_student_name_r != "''":
				opr_string = "\
					update student\
					set student_name= " + string_student_name_r\
					+ "where(student_no = "\
					+ string_student_no + " and class_no = "\
					+ string_class_no + " and student_name = "\
					+ string_student_name + " and student_sex = "\
				...
				self.cursor.execute(opr_string)
				self.cnxn.commit()
			if string_student_sex_r != "''":
				opr_string = "\
					update student\
					set student_sex = " + string_student_sex_r\
					+ "where(student_no = "\
					+ string_student_no + " and class_no = "\
					+ string_class_no + " and student_name = "\
					+ string_student_name + " and student_sex = "\
				...
				self.cursor.execute(opr_string)
				self.cnxn.commit()
			if string_student_birth_r != "''":
				opr_string = "\
					update student\
					set student_birth = " + string_student_birth_r\
					+ "where(student_no = "\
					+ string_student_no + " and class_no = "\
					+ string_class_no + " and student_name = "\
					+ string_student_name + " and student_sex = "\
				...
				self.cursor.execute(opr_string)
				self.cnxn.commit()
			if string_student_polistatus_r != "''":
				opr_string = "\
					update student\
					set student_polistatus = " + string_student_polistatus_r\
					+ "where(student_no = "\
					+ string_student_no + " and class_no = "\
					+ string_class_no + " and student_name = "\
					+ string_student_name + " and student_sex = "\
				...
				self.cursor.execute(opr_string)
				self.cnxn.commit()
			if string_student_nation_r != "''":
				opr_string = "\
					update student\
					set student_nation = " + string_student_nation_r\
					+ "where(student_no = "\
					+ string_student_no + " and class_no = "\
					+ string_class_no + " and student_name = "\
					+ string_student_name + " and student_sex = "\
				...
				self.cursor.execute(opr_string)
				self.cnxn.commit()
			if string_student_home_r != "''":
				opr_string = "\
					update student\
					set student_home = " + string_student_home_r\
					+ "where(student_no = "\
					+ string_student_no + " and class_no = "\
					+ string_class_no + " and student_name = "\
					+ string_student_name + " and student_sex = "\
				...
				self.cursor.execute(opr_string)
				self.cnxn.commit()
			if string_student_home_tel_r != "''":
				opr_string = "\
					update student\
					set student_home_tel = " + string_student_home_tel_r\
					+ "student_no = "\
					+ string_student_no + " and class_no = "\
					+ string_class_no + " and student_name = "\
					+ string_student_name + " and student_sex = "\
				...
				self.cursor.execute(opr_string)
				self.cnxn.commit()
			if string_student_spec_r != "''":
				opr_string = "\
					update student\
					set student_spec = " + string_student_spec_r\
					+ "student_no = "\
					+ string_student_no + " and class_no = "\
					+ string_class_no + " and student_name = "\
					+ string_student_name + " and student_sex = "\
				...
				self.cursor.execute(opr_string)
				self.cnxn.commit()
			if string_student_entry_r != '':
				opr_string = "\
					update student\
					set student_entry = " + string_student_entry_r\
					+ "student_no = "\
					+ string_student_no + " and class_no = "\
					+ string_class_no + " and student_name = "\
					+ string_student_name + " and student_sex = "\
				...
				self.cursor.execute(opr_string)
				self.cnxn.commit()
			if string_student_pwd_r != "''":
				opr_string = "\
					update student\
					set student_pwd = " + string_student_pwd_r\
					+ "student_no = "\
					+ string_student_no + " and class_no = "\
					+ string_class_no + " and student_name = "\
					+ string_student_name + " and student_sex = "\
